            ...
            <div class="col-md-6">
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <p class="mb-1"><strong>Package:</strong> {{ data_get($order->selected_tier, 'title', 'Base Service') }}</p>
                        <p class="mb-1"><strong>Add-ons:</strong> {{ collect($order->selected_addons ?? [])->pluck('name')->implode(', ') ?: 'None' }}</p>
